...
import controller.controller.TrailerScreenController;
...
public class TrailerScreen extends JPanel implements TrailerScreenObserver {
    
    private TrailerScreenController controller;
    ...
    public TrailerScreen() {
        controller = new TrailerScreenController(this);
    ...
    private void initialize() {
        ...
        //JLABEL lblNpc1
        JLabel lblNpc1 = new JLabel(GlobalVariables.IMAGES.get(GlobalVariables.NPC9_KEY));
        lblNpc1.setBounds(GlobalVariables.TILE_SIZE*19, GlobalVariables.TILE_SIZE*13, GlobalVariables.TILE_SIZE, GlobalVariables.TILE_SIZE*2);
        //JLABEL lblTeleport
    ...
    protected void paintComponent(Graphics g) {
        g.drawImage(GlobalVariables.IMAGES.get(GlobalVariables.TRAILER_SCREEN_MAP_KEY).getImage(), 0, 0, null);
    }
}
