...
public class GlobalVariables {
    ...
    static {
        try {
            ...
            IMAGES.put(PLAYER_IDLE_TOP_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/amelia_top.png")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_IDLE_DOWN_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/amelia_down.png")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_IDLE_LEFT_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/amelia_left.png")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_IDLE_RIGHT_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/amelia_right.png")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_ANIMATION_TOP_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/gif/amelia_down_run.gif")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_ANIMATION_DOWN_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/gif/amelia_top_run.gif")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_ANIMATION_LEFT_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/gif/amelia_left_run.gif")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
            IMAGES.put(PLAYER_ANIMATION_RIGHT_KEY, ImageIO.read(new File("./src/view/assets/images/player_fem/gif/amelia_right_run.gif")).getScaledInstance(TILE_SIZE, TILE_SIZE*2, Image.SCALE_SMOOTH));
